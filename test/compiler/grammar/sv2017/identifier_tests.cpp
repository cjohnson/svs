...
{
    EXPECT_PARSE_FAILURE<sv2017::system_tf_identifier>("");
}

TEST(SV2017SystemTFIdentifierTests, FailsToParseWithoutLeadingDollarSign)
{
    EXPECT_PARSE_FAILURE<sv2017::system_tf_identifier>("simple_identifier");
}
...
{
    EXPECT_PARSE_RESULT<sv2017::system_tf_identifier>("$display", "display");
    EXPECT_PARSE_RESULT<sv2017::system_tf_identifier>("$bitstoreal", "bitstoreal");
    EXPECT_PARSE_RESULT<sv2017::system_tf_identifier>("$q_remove", "q_remove");
}
...
TEST(SV2017SystemTFIdentifierTests, ParsesWithWhitespaceAtEnd)
{
    EXPECT_PARSE_RESULT<sv2017::system_tf_identifier>("$display ", "display");
    EXPECT_PARSE_RESULT<sv2017::system_tf_identifier>("$display\t", "display");
    EXPECT_PARSE_RESULT<sv2017::system_tf_identifier>("$display\n", "display");
}
...
{
    EXPECT_PARSE_FAILURE<sv2017::simple_identifier>("$display");
}

TEST(SV2017SimpleIdentifierTests, ParsesTestsFromSpec)
{
    EXPECT_PARSE_RESULT<sv2017::simple_identifier>("shiftreg_a");
    EXPECT_PARSE_RESULT<sv2017::simple_identifier>("busa_index");
    EXPECT_PARSE_RESULT<sv2017::simple_identifier>("error_condition");
    EXPECT_PARSE_RESULT<sv2017::simple_identifier>("merge_ab");
    EXPECT_PARSE_RESULT<sv2017::simple_identifier>("_bus3");
    EXPECT_PARSE_RESULT<sv2017::simple_identifier>("n$657");
}
...
{
    EXPECT_PARSE_FAILURE<sv2017::escaped_identifier>("");
}
...
{
    EXPECT_PARSE_RESULT<sv2017::escaped_identifier>("\\busa+index ", "busa+index");
    EXPECT_PARSE_RESULT<sv2017::escaped_identifier>("\\-clock\n", "-clock");
    EXPECT_PARSE_RESULT<sv2017::escaped_identifier>("\\***error-condition***\n", "***error-condition***");
    EXPECT_PARSE_RESULT<sv2017::escaped_identifier>("\\net1/\\net2\n", "net1/\\net2");
    EXPECT_PARSE_RESULT<sv2017::escaped_identifier>("\\{a,b}\n", "{a,b}");
    EXPECT_PARSE_RESULT<sv2017::escaped_identifier>("\\a*(b+c)\n", "a*(b+c)");
}

TEST(SV2017IdentifierTests, ParsesBasicSimpleIdentifier)
{
    EXPECT_PARSE_RESULT<sv2017::identifier>("tail_ptr");
}

TEST(SV2017IdentifierTests, ParsesBasicEscapedIdentifier)
{
    EXPECT_PARSE_RESULT<sv2017::identifier>("\\we'ra;ravj.....", "we'ra;ravj.....");
}
